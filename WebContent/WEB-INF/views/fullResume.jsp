...
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/full-resume-style.css">
</head>
 ...
 <div class="heading">Projects</div>
        <ul>
            ...
            <li class="bullet">Fractal Program</li>
            	<ul>
            		<li class="subbullet">Programmed and displayed the Mandelbrot fractal using a coordinate plane</li>
            		<li class="subbullet">Used equations involving imaginary numbers to plot points</li>
            	</ul>
        </ul>
    
 <div class="heading">Experience</div>
        <ul>
            <li class="bullet">Enterprise Technology Intern at State Farm Insurance (June 2018 - July 2018)</li><br>
            <li class="bullet">IT Student Intern at State Farm Insurance (June 2017 - August 2017) </li>
            <ul>
                <li class="subbullet">Worked on the Client and Application Virtualization Team</li>
                <li class="subbullet">Assisted with the deployment and organization of virtual applications and clients</li>
